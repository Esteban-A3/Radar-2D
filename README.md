...
Proyecto desarrollado por **Dominick Rodríguez** y **Esteban Sánchez** como parte del sistema **Radar-2D**, integrando Arduino y Python para la detección, procesamiento y visualización de objetos en tiempo real.# Radar-2D - Comunicación Serial 🔌📡
